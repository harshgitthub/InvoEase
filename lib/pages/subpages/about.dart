...
// //     ),
// //     drawer: drawer(context),
// //     body: selectedTemplate == 'Spreadsheet' ? pdf2() : pdf1(),
// //   );
// // }

// // StreamBuilder<QuerySnapshot> pdf1() {
...
// // StreamBuilder<QuerySnapshot> pdf2() {
// //   return StreamBuilder<QuerySnapshot>(
// //     stream: FirebaseFirestore.instance
// //         .collection('USERS')
// //         .doc(currentUser?.uid)
...
// // // StreamBuilder<QuerySnapshot<Object?>> pdf1() {
...
//     final file = File('${outputDir.path}/invoice_${invoice.id}.pdf');
//     await file.writeAsBytes(await pdf.save());
...
//     // Save the PDF file
//     final outputDir = await getApplicationDocumentsDirectory();
//     final file = File('${outputDir.path}/spreadsheet_invoice_${invoice.id}.pdf');
//     await file.writeAsBytes(await pdf.save());
...
//       await _createAndSaveSpreadsheetPdf(invoice, _organizationData);
//     } else {
//       await _createAndSavePdf(invoice, _organizationData);
//     }
//   }
...
//             onPressed: () async {
//               // Fetch invoice data by passing a specific invoice ID
//               Invoice invoice = await _fetchInvoiceData('invoiceId123');
...
//     setState(() {
//       var termsAndConditions = tempList; // Assuming 'termsAndConditions' is a member variable
//     });
//   } catch (e) {
